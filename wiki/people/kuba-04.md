...
## Scope
Observed activity across 2 repos in the [marmot-protocol](https://github.com/marmot-protocol) GitHub organization over the last 180 days; 2 tracked contributions. Focus areas (as observed from repositories touched):

- White Noise — Rust core (`whitenoise-rs`)
...
## Accounts
- GitHub: [kuba-04](https://github.com/kuba-04)
