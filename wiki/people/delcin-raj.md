...
**Canonical id:** `person_delcin-raj`
**Status:** active
...
## Scope
Observed activity across 1 repo in the [marmot-protocol](https://github.com/marmot-protocol) GitHub organization over the last 180 days; 33 tracked contributions. Focus areas (as observed from repositories touched):
...
## Accounts
- GitHub: [delcin-raj](https://github.com/delcin-raj)
