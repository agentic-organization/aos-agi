...
**Canonical id:** `person_hzrd149`
**Status:** active
**Primary affiliation:** [[teams/marmot-protocol]]

## Role
- Lead contributor — TypeScript Marmot (`marmot-ts`, `marmots-web-chat`)

## Scope
Observed activity across 4 repos in the [marmot-protocol](https://github.com/marmot-protocol) GitHub organization over the last 180 days; 360 tracked contributions. Focus areas (as observed from repositories touched):
...
## Accounts
- GitHub: [hzrd149](https://github.com/hzrd149)
