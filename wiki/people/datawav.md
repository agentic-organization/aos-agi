...
## Scope
Observed activity across 3 repos in the [marmot-protocol](https://github.com/marmot-protocol) GitHub organization over the last 180 days; 7 tracked contributions. Focus areas (as observed from repositories touched):

- White Noise — Flutter app (`whitenoise`)
...
## Accounts
- GitHub: [Datawav](https://github.com/Datawav)
