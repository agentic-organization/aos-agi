...
## Summary
Sync Nostr events between relays using NIP-77 negentropy

## Repository
- GitHub: [divinevideo/divine-relay-sync](https://github.com/divinevideo/divine-relay-sync)
- Primary language: **Rust** · stars: 1 · default branch: `main`

## Top contributors
- [[people/rabble]] — 26 contributions
- [[people/notthatkindofdrliz]] — 1 contributions

## Related
- Syncs Nostr events between relays using NIP-77 negentropy — Divine's relay-to-relay fabric.
