...
## Summary
Nostr AI Video Detector - Multi-provider deepfake detection for Nostr video events

## Repository
- GitHub: [divinevideo/divine-realness](https://github.com/divinevideo/divine-realness)
- Primary language: **TypeScript** · stars: 1 · default branch: `main`

## Top contributors
- [[people/rabble]] — 11 contributions
- [[people/notthatkindofdrliz]] — 1 contributions
- [[people/mbradley]] — 1 contributions

## Related
- Complements [[projects/divine-moderation-service]] — AI-video detection specifically (deepfakes, AI-generated content).
