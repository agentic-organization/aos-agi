...
- 2026-05-24: Daily ingestion (`data/raw/github/daily/2026-05-24/divinevideo/divine-mobile/`) shows **17 commits** and **41 updated issues**. Themes: DM emoji reactions on messages (#4633), web support added to Divine Video Player (#4664), view tracking made durable (#4677), notification comment-reply classification (#4673), video-metadata classic post-form controls restored (#4686), tags-picker search results kept visible after selection (#4663), Divine client tags standardized (#4671), invite-status lifecycle guarded (#4648), notification video routes stabilized (#4669), BYOK nsec strip from Keycast OAuth reverted (#4675), Bloc error reports enriched with last event/state/build tag (#4666), collaborator invites recovered from outgoing DM queue (#4642). Committers: [[people/rabble]] (5), [[people/liz-sweigart]] (4), [[people/meylis-annagurbanov]] (3), [[people/alex-frei]] (3), [[people/realmeylisdev]] (2).
