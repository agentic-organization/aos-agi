...
- 2026-05-24: Daily ingestion (`data/raw/github/daily/2026-05-24/`) shows concentrated TypeScript-stack activity: [[projects/cashu-ts]] (5 commits by [[people/robwoodgate]] — releases v5.0.0-rc.1 and v4.5.1, NUT-04/05 `method_name`, scoped `fetch` hooks, v4-deprecated API removal), [[projects/cdk]] (9 issues updated), [[projects/coco]] (4 issues), [[projects/nuts]] (2 issues), [[projects/nutshell]] (2 issues), [[projects/cashu.me]] (2 releases), [[projects/orchard]] (100 events). External wallets [[projects/minibits]] (37 events), [[projects/macadamia]] (47 events), and [[projects/zapstore]] (24 releases/100 events) also active.

- 2026-05-25: Daily ingestion (`data/raw/github/daily/2026-05-25/`) shows continued Cashu ecosystem activity across the `cashubtc` org. [[projects/cdk]]: 11 PushEvents, 22 PRs, 10 issues, 11 issues/PRs updated (NUT-XX wallet recovery, auth websocket handling, Apache license, golang release). [[projects/nutshell]]: 34 PushEvents, 18 PRs, 5 issues — high churn continuing. [[projects/cashu-ts]]: 100 events, 100 PRs, 71 releases (historical batch). [[projects/coco]]: 100 events, 100 PRs, 23 releases. [[projects/numo]]: 100 events, 100 PRs, 31 releases. [[projects/orchard]]: 72 events, 100 PRs, 25 releases. [[projects/cashu.me]]: 51 events, 100 PRs, 2 releases. [[projects/eNuts]]: 26 events, 100 PRs, 21 releases. [[projects/cashu.ts]] release pipeline v5.0.0-rc.1 advancing. External wallets: [[projects/minibits]] (37 events, 43 PRs), [[projects/macadamia]] (47 events, 46 PRs), [[projects/zapstore]] (100 events, 41 PRs, 24 releases) also active in the window.
