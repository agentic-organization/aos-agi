...
## Summary
TypeScript/JavaScript OAuth client for Divine (Keycast) authentication and Nostr signing via REST RPC

## Repository
- GitHub: [divinevideo/divine-login](https://github.com/divinevideo/divine-login)
- Primary language: **TypeScript** · stars: 0 · default branch: `main`

## Top contributors
- [[people/dcadenas]] — 7 contributions
- [[people/rabble]] — 3 contributions
- [[people/notthatkindofdrliz]] — 1 contributions

## Related
- [[projects/keycast]] — the auth service this client talks to (OAuth / PKCE / BYOK Nostr signing).
