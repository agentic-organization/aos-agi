...
## Summary
An LMDB storage adapter implementing the OpenMLS storage traits

## Repository
- GitHub: [marmot-protocol/openmls-lmdb-storage](https://github.com/marmot-protocol/openmls-lmdb-storage)
- Primary language: **Rust** · stars: 1 · default branch: `master`


## Top contributors
- [[people/erskingardner]] — 2 contributions
...
## Related
- Sibling storage adapters: [[projects/openmls-sled-storage]], [[projects/openmls-redb-storage]]
