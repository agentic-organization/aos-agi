...
## Summary
DiVine Space - MySpace-inspired video social network on Nostr

## Repository
- GitHub: [divinevideo/divine-space](https://github.com/divinevideo/divine-space)
- Primary language: **TypeScript** · stars: 1 · default branch: `main`

## Top contributors
- [[people/rabble]] — 95 contributions
- `shakespeare-diy` — 2 contributions *(bot/automation account)*
- [[people/notthatkindofdrliz]] — 1 contributions

## Related
- MySpace-inspired video social network layer on Nostr; sibling to [[projects/divine-web]].
