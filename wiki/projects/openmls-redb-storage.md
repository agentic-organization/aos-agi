...
## Repository
- GitHub: [marmot-protocol/openmls-redb-storage](https://github.com/marmot-protocol/openmls-redb-storage)
- Primary language: **Rust** · stars: 0 · default branch: `master`


## Top contributors
- [[people/erskingardner]] — 4 contributions
...
## Related
- Sibling storage adapters: [[projects/openmls-sled-storage]], [[projects/openmls-lmdb-storage]]
