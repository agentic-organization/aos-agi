...
## Summary
An implementation of the OpenMLS storage traits using Sled embedded database

## Repository
- GitHub: [marmot-protocol/openmls-sled-storage](https://github.com/marmot-protocol/openmls-sled-storage)
- Primary language: **Rust** · stars: 2 · default branch: `master`


## Top contributors
- [[people/erskingardner]] — 19 contributions
...
## Related
- Sibling storage adapters: [[projects/openmls-redb-storage]], [[projects/openmls-lmdb-storage]]
- All three implement OpenMLS storage traits for different embedded DB backends.
