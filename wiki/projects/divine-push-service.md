...
## Summary
Push notification service for diVine mobile app

## Repository
- GitHub: [divinevideo/divine-push-service](https://github.com/divinevideo/divine-push-service)
- Primary language: **Rust** · stars: 0 · default branch: `main`

## Top contributors
- [[people/dcadenas]] — 54 contributions
- `nbenmoody` — 2 contributions *(occasional; no page)*
- [[people/notthatkindofdrliz]] — 1 contributions
- [[people/sergey3bv]] — 1 contributions
- `verse-ci` — 1 contributions *(bot/automation account)*

## Related
- Push notifications for [[projects/divine-mobile]].
